    ...
    <div class="app horizontal-menu app-auth-sign-up align-content-stretch d-flex flex-wrap justify-content-end">
        ...
        <div class="app-auth-container">
            ...
            <div class="auth-credentials m-b-xxl">
                <label for="signUpUsername" class="form-label">Contact No</label>
                <input type="number" class="form-control m-b-md" id="signUpUsername" aria-describedby="signUpUsername"
