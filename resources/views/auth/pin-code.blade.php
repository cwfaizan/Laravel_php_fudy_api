...
<body>
    <div class="app horizontal-menu app-auth-sign-up align-content-stretch d-flex flex-wrap justify-content-end">
        ...
        <div class="app-auth-container">
            ...
            <form action="{{ route('pin.verify') }}" method="get" enctype="multipart/form-data">
                @csrf
                <div class="auth-credentials m-b-xxl">
                    <input type="hidden" name="user_id" value="{{ $user_id }}">
                    <input type="hidden" name="pin_type" value="{{ $pin_type }}">
                    <label for="signInPin" class="form-label">Pin Code</label>
                    <input type="text" name="pin" class="form-control" id="signInPin"
                        aria-describedby="signInPin"
                    ...
                    <div class="auth-submit">
                        <button type="submit" class="btn btn-primary">Verify Pin Code</button>
                    </div>
                </form>
